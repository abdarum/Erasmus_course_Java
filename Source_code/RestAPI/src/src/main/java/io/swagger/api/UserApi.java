...
public interface UserApi {
    ...
    @ApiResponses(value = { 
        @ApiResponse(code = 403, message = "Forbidden, current user has no permission to create new user of selected type"),
    ...
    @ApiOperation(value = "Get user statistics by user name", nickname = "getStatsByUsername", notes = "", response = UserStatus.class, authorizations = {
        @Authorization(value = "bearerAuth")    }, tags={ "user", })
    @ApiResponses(value = { 
        @ApiResponse(code = 200, message = "successful operation", response = UserStatus.class),
        @ApiResponse(code = 400, message = "Invalid username supplied"),
        @ApiResponse(code = 404, message = "User not found") })
    @RequestMapping(value = "/user/{username}/stats",
        produces = { "application/json" }, 
        method = RequestMethod.GET)
    ResponseEntity<UserStatus> getStatsByUsername(@ApiParam(value = "",required=true) @PathVariable("username") String username
);
    ...
    @ApiOperation(value = "Logs user into the system", nickname = "loginUser", notes = "", response = String.class, authorizations = {
        @Authorization(value = "bearerAuth")    }, tags={ "user", })
    @ApiResponses(value = { 
